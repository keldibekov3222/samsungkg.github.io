var Swiper=function(type,selector,params){'use strict';if(!document.body.outerHTML&&document.body.__defineGetter__){if(HTMLElement){var element=HTMLElement.prototype;if(element.__defineGetter__){element.__defineGetter__('outerHTML',function(){return new XMLSerializer().serializeToString(this)})}}}
...
var _this=this;_this.touches={start:0,startX:0,startY:0,current:0,currentX:0,currentY:0,diff:0,abs:0};_this.positions={start:0,abs:0,diff:0,current:0};_this.times={start:0,end:0};_this.id=(new Date()).getTime();_this.container=(selector.nodeType)?selector:$$(selector)[0];_this.isTouched=!1;_this.isMoved=!1;_this.activeIndex=0;_this.centerIndex=0;_this.activeLoaderIndex=0;_this.activeLoopIndex=0;_this.previousIndex=null;_this.velocity=0;_this.snapGrid=[];_this.slidesGrid=[];_this.imagesToLoad=[];_this.imagesLoaded=0;_this.wrapperLeft=0;_this.wrapperRight=0;_this.wrapperTop=0;_this.wrapperBottom=0;_this.isAndroid=navigator.userAgent.toLowerCase().indexOf('android')>=0;var wrapper,slideSize,wrapperSize,direction,isScrolling,containerSize;if(type=='g-slider-kb'){params={nextButton:'.productlist-kb .swiper-button-next',prevButton:'.productlist-kb .swiper-button-prev',pagination:'.productlist-kb .swiper-pagination',paginationClickable:!0,slidesPerView:1,spaceBetween:0,keyboardControl:!0}}else if(type=='main-suggestions'){params={nextButton:'.main-suggestions .swiper-button-next',prevButton:'.main-suggestions .swiper-button-prev',slidesPerView:1,spaceBetween:0,keyboardControl:!0}}else if(type=='summary-product'){params={calculateHeight:!0,pagination:'.summary-product .swiper-pagination',prevButton:'.summary-product .swiper-button-prev',nextButton:'.summary-product .swiper-button-next',paginationClickable:!0,slidesPerView:1,spaceBetween:0}}else if(type=='gallery-top'){params={nextButton:'.slider-zoom .swiper-button-next',prevButton:'.slider-zoom .swiper-button-prev',spaceBetween:10,loop:!0,loopedSlides:5}}else if(type=='gallery-thumbs'){params={spaceBetween:10,slidesPerView:5,touchRatio:0.2,loop:!0,loopedSlides:5,prevButton:'.nav-prev',nextButton:'.nav-next',slideToClickedSlide:!0}}else if(type=='wideSlide1'){params={nextButton:'.wide-slider1 .swiper-button-next',prevButton:'.wide-slider1 .swiper-button-prev'}}else if(type=='showcaseOverview'){params={pagination:'.swiper-pagination',slidesPerView:1,spaceBetween:0}}else if(type=='wideSlide2'){params={loop:!0,autoplay:5000,pauseOnHover:!0,calculateHeight:!0,pagination:'.smain-eventKeybanner .swiper-pagination',nextButton:'.smain-eventKeybanner .swiper-button-next',prevButton:'.smain-eventKeybanner .swiper-button-prev',paginationClickable:!0,onSlideChangeStart:function(swiper){$('.wide-slider2 .swiper-slide iframe').remove();$('.wide-slider2 .swiper-slide').removeClass('is-play')}}}else if(type=='lineUp'){params={nextButton:'.videowall-cont-lineup .swiper-button-next',prevButton:'.videowall-cont-lineup .swiper-button-prev',slidesPerView:3,spaceBetween:10,centeredSlides:!1,pagination:'.videowall-cont-lineup .swiper-pagination',paginationClickable:!0,breakpoints:{767:{centeredSlides:!0,slidesPerView:1.5},1024:{slidesPerView:3,centeredSlides:!1}}}}else if(type=='outClients'){params={calculateHeight:!0,nextButton:'.g-box-retail-our .swiper-button-next',prevButton:'.g-box-retail-our .swiper-button-prev',pagination:'.g-box-retail-our .swiper-pagination',paginationClickable:!0}}else if(type=='WideSliderNew'){params={calculateHeight:!0,nextButton:'.wide-slider_new .swiper-button-next',prevButton:'.wide-slider_new .swiper-button-prev',pagination:'.wide-slider_new .swiper-pagination',paginationClickable:!0}}else if(type=='suggestArea'){params={calculateHeight:!0,nextButton:'.main-suggestions .swiper-button-next',prevButton:'.main-suggestions .swiper-button-prev',pagination:'.main-suggestions .swiper-pagination',paginationClickable:!0}}else if(type=='miComponents'){params={calculateHeight:!0,nextButton:'.g-textBox-author .swiper-button-next',prevButton:'.g-textBox-author.swiper-button-prev',pagination:'.g-textBox-author .swiper-pagination',paginationClickable:!0}}else if(type=='g-monitor-kb'){params={nextButton:'.g-monitor-kb .swiper-button-next',prevButton:'.g-monitor-kb.swiper-button-prev',pagination:'.g-monitor-kb .swiper-pagination',paginationClickable:!0}}else if(type=='g-led-signage-kb'){params={nextButton:'.g-led-signage-kb .swiper-button-next',prevButton:'.g-led-signage-kbb .swiper-button-prev',pagination:'.g-led-signage-kb .swiper-pagination',paginationClickable:!0}}else if(type=='search-mb'){params={loop:!0,slidesPerView:'auto',pagination:'.newSearchMb .swiper-pagination',paginationClickable:!0}}else if(type=='search-realtime'){params={mode:'vertical',loop:!0,autoplay:3000}}else if(type=='custom'){}
...
if(direction==='toNext'&&(timeDiff>300)){if(diffAbs>=targetSlideSize*params.longSwipesRatio){_this.swipeNext(!0,!0)}
else{_this.swipeReset()}}
if(direction==='toPrev'&&(timeDiff>300)){if(diffAbs>=targetSlideSize*params.longSwipesRatio){_this.swipePrev(!0,!0)}
else{_this.swipeReset()}}
...
function noSwipingSlide(el){var noSwiping=!1;do{if(hasClass(el,params.noSwipingClass))
{noSwiping=!0}
...
else{if(typeof autoplayIntervalId!=='undefined')return!1;if(!params.autoplay)return;_this.callPlugins('onAutoplayStart');if(params.onAutoplayStart)_this.fireCallback(params.onAutoplayStart,_this);autoplayIntervalId=setInterval(function(){if(params.loop){_this.fixLoop();_this.swipeNext(!0,!0)}
else if(!_this.swipeNext(!0,!0)){if(!params.autoplayStopOnLast)_this.swipeTo(0);else{clearInterval(autoplayIntervalId);autoplayIntervalId=undefined}}},params.autoplay)}};_this.stopAutoplay=function(internal){if(_this.support.transitions){if(!autoplayTimeoutId)return;if(autoplayTimeoutId)clearTimeout(autoplayTimeoutId);autoplayTimeoutId=undefined;if(internal&&!params.autoplayDisableOnInteraction){_this.wrapperTransitionEnd(function(){autoplay()})}
_this.callPlugins('onAutoplayStop');if(params.onAutoplayStop)_this.fireCallback(params.onAutoplayStop,_this)}
else{if(autoplayIntervalId)clearInterval(autoplayIntervalId);autoplayIntervalId=undefined;_this.callPlugins('onAutoplayStop');if(params.onAutoplayStop)_this.fireCallback(params.onAutoplayStop,_this)}};function autoplay(){autoplayTimeoutId=setTimeout(function(){if(params.loop){_this.fixLoop();_this.swipeNext(!0,!0)}
else if(!_this.swipeNext(!0,!0)){if(!params.autoplayStopOnLast)_this.swipeTo(0);else{clearTimeout(autoplayTimeoutId);autoplayTimeoutId=undefined}}
